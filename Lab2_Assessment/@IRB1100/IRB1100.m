...
%% Constructor
    ...
    %% CreateModel
        function CreateModel(self)
            ...
            link(1) = Link('d',0.4,'a',0,'alpha',pi/2,'qlim',deg2rad([-230 230]), 'offset',0);
            link(2) = Link('d',-0.015,'a',0.35,'alpha',0,'qlim', deg2rad([-115 113]), 'offset', pi/2);
            link(3) = Link('d',-0.035 ,'a',0.04,'alpha',-pi/2,'qlim', deg2rad([-205 55]), 'offset', 0);
            link(4) = Link('d',0.4,'a', 0,'alpha',-pi/2,'qlim',deg2rad([-230 230]),'offset', 0);
            link(5) = Link('d',-0.04 ,'a',0,'alpha',pi/2,'qlim',deg2rad([-125,120]), 'offset',0);

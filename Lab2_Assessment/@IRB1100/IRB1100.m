...
%% Constructor
    ...
    %% CreateModel
        function CreateModel(self)
            ...
            link(1) = Link('d',0.65,'a',0,'alpha',0,'qlim',deg2rad([-230 230]), 'offset',0);
            link(2) = Link('d',0.75,'a',0,'alpha',pi/2,'qlim', deg2rad([-115 113]), 'offset', 0);
            link(3) = Link('d',1.3 ,'a',0,'alpha',0,'qlim', deg2rad([-205 55]), 'offset', 0);
